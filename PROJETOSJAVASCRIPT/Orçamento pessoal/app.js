class Despesa {
	...
	recuperarTodosRegistros(){
		...
		//recureprar todas as despesas cadastradas no local storage
		for (let i = 1; i <= id; i++) {

			//recuperar a despesa
			let despesa = JSON.parse(localStorage.getItem(i))

			//teste de existir possibilidadde de haver indices removidos
			//assim pularemos os indices
			if (despesa === null) {
				continue
			}
...
function carregalistaDespesas(despesas = Array(), filtro = false) {
	...
	//selecionando o elemento tbody da consulta
